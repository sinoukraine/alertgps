    ...
    Helper: {
        ...
        getAssetStateInfo: function(asset){
            /*
                ...
                state-3  -- red
            */
            //var staticIdle = asset.getStaticTimeSpan();
            var ret = {};
            if (asset) {
                ...
                ret.geolock = false;
                if (asset.posInfo.status & Protocol.PositionStatus.BeProtected > 0) {
                    ret.geolock = true;
                }
                ret.immobilisation = false;
                if (asset.posInfo.status & Protocol.PositionStatus.Relay > 0) {
                    ret.immobilisation = true;
                }
